    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        {services.map((service, index) => (
          <article
            key={service.title}
            className="surface-card rounded-xl bg-[#111722]/84 p-4 transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(0,0,0,0.28),0_0_18px_rgba(55,208,201,0.07)]"
          >
